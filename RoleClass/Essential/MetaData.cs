namespace RoleClass.Essential
{
	internal struct MetaData
	{
		...
		internal const string Revision = "A";
		internal const string Version = MajorVersion + "." + MinorVersion + "." + Build + "-" + Revision;
		internal const int SmodMajor = 3;
		internal const int SmodMinor = 2;
		internal const int SmodBuild = 2;
	}
}
